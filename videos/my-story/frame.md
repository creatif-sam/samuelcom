...
description: >
  ...
  identical and sacred — the five-tone warm-stone palette, Poppins 400 + Poppins, the
...
typography:
  # — reading ramp (Poppins) —
  body:        { fontFamily: "Poppins", cqw: 1.0,  weight: 400, lineHeight: 1.6, color: "text-secondary" }
  body-sm:     { fontFamily: "Poppins", cqw: 0.85, weight: 400, lineHeight: 1.6 }
  subtitle:    { fontFamily: "Poppins", cqw: 1.3,  weight: 400, lineHeight: 1.5 }
  label:       { fontFamily: "Poppins", px: 14, weight: 500, tracking: "3px", upper: true, color: "accent" }
  attribution: { fontFamily: "Poppins", px: 15, weight: 400, tracking: "2px", upper: true, color: "accent" }
  micro:       { fontFamily: "Poppins", px: 12, weight: 400, tracking: "2px", upper: true, color: "accent" }
  # — display / hero ramp (Poppins 400, sentence case) —
  h3:          { fontFamily: "Poppins", cqw: 1.8, weight: 400, lineHeight: 1.1 }
  timeline-headline:{ fontFamily: "Poppins", cqw: 1.9, weight: 400, lineHeight: 1.1 }
  card-headline:{ fontFamily: "Poppins", cqw: 2.0, weight: 400, lineHeight: 1.15 }
  stat-figure: { fontFamily: "Poppins", cqw: 3.0, weight: 400, lineHeight: 1.0 }
  quote-mark:  { fontFamily: "Poppins", cqw: 9.0, weight: 400, lineHeight: 0.5, color: "line" }
  h2:          { fontFamily: "Poppins", cqw: 4.0, weight: 400, lineHeight: 1.1 }
  h1:          { fontFamily: "Poppins", cqw: 6.2, weight: 400, lineHeight: 1.06 }
  display:     { fontFamily: "Poppins", cqw: 8.0, weight: 400, lineHeight: 1.04 }
...
- **Fonts** — already set to **Poppins** (display) / **Poppins** (body); ignore any preset font name lingering in prose.
...
The voice is a literary pairing: **Poppins** at weight 400 (the thin-stroke didone, never
bold, always sentence case) carries every headline, numeral, and quote mark in ink; **Poppins**
...
- **Poppins 400** (ink, sentence case) for display; **Poppins** body (gray) + labels (taupe, tracked).
...
Two ramps. The **reading ramp** (Poppins body 1.0cqw gray, labels in px taupe) carries copy + chrome;
...
- **Playfair at 400, ink, sentence case** — never bold, never uppercase, never taupe. **Poppins labels uppercase, 2–3px tracked, taupe.** Italic via Playfair italic for emphasis only.

## Depth & Surface

The flat plane is the only technique. Hierarchy from:

- **Type contrast** — Playfair serif vs Poppins sans; the 8cqw→0.7cqw scale.
...
**Ground** `{colors.bg-primary}`, `pad-x`. **Composes** geo-ring (right, ~34cqw, solid+dashed), vertical-line (left), label, display/h1. **Focal** a 2–3 line Playfair `display`/`h1` headline in ink (italic on the key word), left-anchored, with a taupe `label` above and an Poppins subtitle below. **Chrome** optional bottom meta row (Playfair value + taupe label). **Accent** the geo ring; optionally one `horizontal-accent` ink line (if it clears the meta). **Silence** ~55% empty. **Fixed** Playfair 400 ink sentence-case, ≤2 geo elements, 1px lines. **Free** title, ring placement, meta. **Density** sparse.
...
- **Poppins + Poppins via Google Fonts.** CJK pairing (Noto Serif SC 700/400) carries over; Playfair has no Hanzi italic — substitute weight/taupe for emphasis.
