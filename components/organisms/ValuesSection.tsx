    ...
    <section ref={sectionRef} id="values" className="values-section">
      <style>{`
        ...
        .values-section::before {
          ...
          inset: 0;
          background-image:
            linear-gradient(rgba(84,108,250,.04) 1px, transparent 1px),
            linear-gradient(90deg, rgba(84,108,250,.04) 1px, transparent 1px);
        ...
        .values-section::after {
          ...
          background: radial-gradient(circle, rgba(84,108,250,.06) 0%, transparent 70%);
          pointer-events: none;
        }
        ...
        .vs-card {
          ...
          border: 1px solid rgba(84,108,250,0.1);
          overflow: hidden;
          opacity: 0;
        ...
        .vs-card:hover {
          ...
          border-color: rgba(84,108,250,0.35);
        }
        ...
        .vts-item + .vts-item::before {
          ...
          background: rgba(84,108,250,0.25);
        }
