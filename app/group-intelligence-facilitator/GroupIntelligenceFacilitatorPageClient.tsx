...
const css = `
  ...
  .gif-cta-btn.ghost {
    ...
    border: 1px solid rgba(84,108,250,.35);
  }
  .gif-cta-btn.ghost:hover { background: rgba(84,108,250,.08); }
...
export default function GroupIntelligenceFacilitatorPageClient() {
  return (
    <>
          ...
          <div className="gif-context">
            <div className="gif-context-side">
              ...
              <div className="gif-stat">
                <div className="gif-stat-num">17+</div>
